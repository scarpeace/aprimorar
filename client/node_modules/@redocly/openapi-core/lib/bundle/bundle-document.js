...
export async function bundleDocument(opts) {
    const { document, config, types, externalRefResolver, dereference = false, removeUnusedComponents = false, keepUrlRefs = false, componentRenamingConflicts, componentNamesStrategy = 'basename', } = opts;
