...
import type { Oas3Schema, Oas3Tag, Oas3_2Tag, Oas3_1Schema, Referenced } from '../typings/openapi.js';
...
export declare function validateExample(example: any, schema: Referenced<Oas3Schema | Oas3_1Schema>, options: {
    location: Location;
    ctx: UserContext;
