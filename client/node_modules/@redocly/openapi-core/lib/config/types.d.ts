...
export type RawGovernanceConfig<T extends 'built-in' | undefined = undefined> = {
    ...
    oas3_0Rules?: RuleMap<Exclude<BuiltInOAS3RuleId, 'spec-no-invalid-tag-parents' | 'spec-no-invalid-encoding-combinations' | 'spec-discriminator-defaultMapping' | 'spec-querystring-parameters'>, RuleConfig, T>;
