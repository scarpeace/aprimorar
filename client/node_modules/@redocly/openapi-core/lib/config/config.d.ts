import { type Oas2RuleSet, type Oas3RuleSet, type Async2RuleSet, type Async3RuleSet, type Arazzo1RuleSet, type Overlay1RuleSet, type OpenRpc1RuleSet, type GraphqlRuleSet, type SpecVersion, type SpecMajorVersion } from '../oas-types.js';
...
export declare class Config {
    ...
    clearIgnoreForRef(ref: string): void;
    saveIgnore(): void;
    ...
    getRulesForSpecVersion(version: SpecMajorVersion): Oas3RuleSet[] | Oas2RuleSet[] | Async2RuleSet[] | Async3RuleSet[] | Arazzo1RuleSet[] | Overlay1RuleSet[] | OpenRpc1RuleSet[] | GraphqlRuleSet[];
