    ...
    getRulesForSpecVersion(version) {
        switch (version) {
            ...
            case 'arazzo1_1': {
                ...
                this.plugins.forEach((p) => p.preprocessors?.arazzo1_1 && arazzo1_1Rules.push(p.preprocessors.arazzo1_1));
                this.plugins.forEach((p) => p.rules?.arazzo1_1 && arazzo1_1Rules.push(p.rules.arazzo1_1));
                this.plugins.forEach((p) => p.decorators?.arazzo1_1 && arazzo1_1Rules.push(p.decorators.arazzo1_1));
