import type { Oas3RuleSet, Oas2RuleSet, Async3RuleSet, Async2RuleSet, Arazzo1RuleSet, Overlay1RuleSet, OpenRpc1RuleSet, GraphqlRuleSet } from '../oas-types.js';
...
export declare function prefixRules<T extends Oas3RuleSet | Oas2RuleSet | Async3RuleSet | Async2RuleSet | Arazzo1RuleSet | Overlay1RuleSet | OpenRpc1RuleSet | GraphqlRuleSet>(rules: T, prefix: string): T;
