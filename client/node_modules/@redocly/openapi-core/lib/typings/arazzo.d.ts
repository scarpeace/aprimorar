...
export type SourceDescription = OpenAPISourceDescription | ArazzoSourceDescription | AsyncAPISourceDescription;
export interface Parameter {
    in?: 'header' | 'query' | 'querystring' | 'path' | 'cookie';
    name: string;
...
export interface Step {
    ...
    outputs?: {
        [key: string]: SelectorObject | string | object | any[] | boolean | number;
    };
...
export interface Workflow {
    ...
    outputs?: {
        [key: string]: SelectorObject | string;
    };
    steps: Step[];
