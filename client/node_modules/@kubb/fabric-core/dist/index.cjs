...
const FileExport = require_onProcessExit.createComponent("FileExport", (props) => {
	...
	return require_parsers_typescript.print(require_parsers_typescript.createExport({
		name,
		path,
		isTypeOnly,
		asAlias
...
const FileImport = require_onProcessExit.createComponent("FileImport", (props) => {
	...
	return require_parsers_typescript.print(require_parsers_typescript.createImport({
		name,
		path,
		root,
		isNameSpace,
