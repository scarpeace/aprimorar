...
const require_telemetry = require("./telemetry-Cj4VP-SC.cjs");
const require_package = require("./package-CLV23EC9.cjs");
...
async function run(argv = process.argv) {
	...
	const [{ command: generateCommand }, { command: validateCommand }, { command: mcpCommand }, { command: initCommand }] = await Promise.all([
		Promise.resolve().then(() => require("./generate-CGK9b0HZ.cjs")),
		Promise.resolve().then(() => require("./validate-BUCaHEf_.cjs")),
		Promise.resolve().then(() => require("./mcp-h_NxxMzd.cjs")),
		Promise.resolve().then(() => require("./init-HQiBEK5e.cjs"))
	]);
	await cli.run([
		generateCommand,
		validateCommand,
