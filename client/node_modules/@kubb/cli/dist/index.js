...
import { n as isTelemetryDisabled } from "./telemetry-DTy9TjCN.js";
import { t as version } from "./package-C7ohaorS.js";
...
async function run(argv = process.argv) {
	...
	const [{ command: generateCommand }, { command: validateCommand }, { command: mcpCommand }, { command: initCommand }] = await Promise.all([
		import("./generate-Cmrd2GHF.js"),
		import("./validate-DkJd7tgy.js"),
		import("./mcp-CnYMNC2_.js"),
		import("./init-Dh0DI8GT.js")
	]);
	await cli.run([
		generateCommand,
		validateCommand,
