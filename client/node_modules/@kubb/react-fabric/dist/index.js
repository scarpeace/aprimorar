...
function Indent({ size = 2, children }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: result.map((child) => {
		if (typeof child === "string") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_jsx_runtime.Fragment, { children: indentString(dedent(child), size) });
...
function useLifecycle() {
	const { exit } = (0, import_react.useContext)(Root.Context);
	return { exit: () => {
		setTimeout(() => {
			exit();
		}, 0);
