...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/defaults.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/definitions.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/global/window.js
var canUseDOM = !!(typeof window !== "undefined" && window.document && window.document.createElement);
var window_default = canUseDOM ? window : {};

// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/dependencyLibs/data.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/dependencyLibs/extend.js
function extend() {
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/dependencyLibs/events.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/dependencyLibs/inputmask.dependencyLib.js
...
function DependencyLib(elem) {
  ...
  if (elem !== void 0 && elem !== null && elem !== window_default) {
    ...
    if (this[0] !== void 0 && this[0] !== null) {
      data_default(this[0], "events", data_default(this[0], "events") || {});
    }
  }
}
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/environment.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/keycode.js
var ignorables = {
  Alt: 18,
  AltGraph: 18,
  ArrowDown: 40,
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/validation-tests.js
...
function determineTestTemplate(pos, tests) {
  ...
  const longestLocator = Math.max(
    ...tests.map(
      (tst) => tst.locator === void 0 ? 0 : tst.locator.length
    )
  ), prevTest = getTest.call(inputmask, pos), prevLocator = getLocator(prevTest, longestLocator);
          ...
          for (let ndx = 0; ndx < altIndexArr.length; ndx++) {
            ...
            for (let ndx1 = 0; ndx1 < maltMatches.length; ndx1++) {
              ...
              for (let ndx2 = 0; ndx2 < malternateMatches.length; ndx2++) {
                ...
                if (typeof altIndex !== "string" || altMatch.alternation !== void 0 && altIndex.indexOf(
        ...
        tests.forEach((mtch) => {
          Object.values(mtch.mloc).forEach((mloc) => {
            mloc.forEach((loc, locNdx) => {
              ...
              if (loc.toString().includes(":") || mergedPos && mergedPos.toString().includes(":"))
                return;
              if (mergedPos === void 0) {
                locator[locNdx] = loc;
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/validation.js
function alternate(maskPos, c, strict, fromIsValid, rAltPos, selection) {
  ...
  const validPsClone = $4.extend(true, [], maskset.validPositions), tstClone = $4.extend(true, {}, maskset.tests);
  ...
  if (result === true) {
    ...
    if (inputmask.hasAlternator && fromAlternate !== true && !strict) {
      ...
      if (result === false) {
        ...
        } else if (opts.numericInput !== true && maskset.tests[maskPos] && maskset.tests[maskPos].length > 1 && getLastValidPosition.call(inputmask, void 0, true) > maskPos) {
          result = alternate.call(inputmask, true) || result;
        }
      }
    }
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/positioning.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/eventhandlers.js
var EventHandlers = {
  ...
  keypressEvent: function(e, checkval, writeOut, strict, ndx) {
    const inputmask = this.inputmask || this, opts = inputmask.opts, $4 = inputmask.dependencyLib, maskset = inputmask.maskset, input = inputmask.el, $input = $4(input);
    let c = e.key;
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/inputHandling.js
  ...
  inputValue.forEach(function(charCode, ndx) {
    if (charCode !== void 0) {
      ...
      if (!isTemplateMatch(initialNdx, charCodes)) {
        ...
        result = getTest.call(inputmask, ndx).match.static === true ? EventHandlers.keypressEvent.call(
          inputmask,
          keypress,
          true,
          false,
...
function unmaskedvalue(input) {
  ...
  if (opts.outputMask && unmaskedValue.length > 0) {
    return inputmask_default.format(unmaskedValue, {
      ...opts,
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/eventruler.js
var EventRuler = {
  ...
  off: function(input, event) {
    if (input.inputmask) {
      const $4 = input.inputmask.dependencyLib;
      $4(input).off(event || ".inputmask");
    }
  }
};

// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/mask.js
function mask() {
  ...
  function isElementTypeSupported(input, opts2) {
    function patchValueProperty(npt) {
      ...
      function getter() {
        if (this.inputmask) {
          return this.inputmask.opts.autoUnmask ? this.inputmask.unmaskedvalue() : getLastValidPosition.call(inputmask) !== -1 || opts2.nullable !== true ? this.getRootNode().activeElement === this && opts2.clearMaskOnLostFocus ? (inputmask.isRTL ? clearOptionalTail.call(inputmask, getBuffer.call(inputmask).slice()).reverse() : clearOptionalTail.call(
            inputmask,
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/escapeRegex.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/masktoken.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/mask-lexer.js
...
function analyseMask(mask2, regexMask, opts) {
  ...
  function insertTestDefinition(mtoken, element, position) {
    ...
    if (regexMask) {
      ...
      if (maskdef && !escaped) {
        if (typeof maskdef.validator === "string" && /\\p\{.*}/i.test(maskdef.validator))
          flag += "u";
        mtoken.matches.splice(position++, 0, {
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/inputmask.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/extensions/inputmask.extensions.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/extensions/inputmask.date.i18n.js
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/extensions/inputmask.date.extensions.js
...
function getTokenizer(opts) {
  if (!opts.tokenizer) {
    const tokens = [], dyntokens = [], formatCodeKeys = Object.keys(formatCode).concat(
...
function parse(format, dateObjValue, opts) {
  let mask2 = "", match, fcode, ndx = 0, escaped = false;
  const placeHolder = {};
  getTokenizer(opts).lastIndex = 0;
...
function getTokenMatch(pos, opts, maskset) {
  let inputmask = this, calcPos = 0, targetMatch, match, matchLength = 0;
  getTokenizer(opts).lastIndex = 0;
  while (match = getTokenizer(opts).exec(opts.inputFormat)) {
...
// ../../node_modules/.pnpm/inputmask@5.0.10-beta.61/node_modules/inputmask/lib/extensions/inputmask.numeric.extensions.js
...
function checkForLeadingZeroes(buffer, opts) {
  let numberMatches = new RegExp(
    "(^" + (opts.negationSymbol.front !== "" ? escapeRegex(opts.negationSymbol.front) + "?" : "") + escapeRegex(opts.prefix) + ")(.*)(" + escapeRegex(opts.suffix) + (opts.negationSymbol.back != "" ? escapeRegex(opts.negationSymbol.back) + "?" : "") + "$)"
...
// src/core/inputmask.ts
var inputmask_default2 = inputmask_default;
...
function getMaskOptions(mask2, _options) {
  const options = {
    jitMasking: false,
    ..._options
  };
  if (!mask2) return options;
  if (typeof mask2 === "string" && ALIAS_MASKS[mask2]) {
    return { ...ALIAS_MASKS[mask2], ...options };
  }
  return {
    mask: mask2,
    ...options
...
function makeMaskCacheKey(fieldName, mask2) {
  return `${fieldName}:${Array.isArray(mask2) ? mask2.join(",") : String(mask2)}`;
}
...
function withMask(mask2, options) {
  if (!options) {
    const cacheKey = makeMaskCacheKey("", mask2);
  ...
  const callback = ((input) => {
    if (isServer_default || mask2 === null || !input) return;
    currentInput = input;
    const maskInput = interopDefaultSync(inputmask_default2)(getMaskOptions(mask2, options));
...
function createMaskInstance(mask2, options) {
  const inputmaskInstance = interopDefaultSync(inputmask_default2);
  return inputmaskInstance(getMaskOptions(mask2, options));
}
function applyMaskToElement(element, mask2, options) {
  if (!element) return;
  const maskInstance = createMaskInstance(mask2, options);
...
//# sourceMappingURL=chunk-PMBRAXS4.cjs.map
//# sourceMappingURL=chunk-PMBRAXS4.cjs.map