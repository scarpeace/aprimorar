...
function dereferenceRef(value, definition, seenRefs) {
  ...
  if (_chunkVQBEI5WIcjs.isRef.call(void 0, value)) {
    if (!definition) {
      return value;
    }
    const ref = value.$ref;
    if (_optionalChain([seenRefs, 'optionalAccess', _2 => _2.has, 'call', _3 => _3(ref)])) {
      return value;
    }
    ...
    try {
      ...
      if (_chunkVQBEI5WIcjs.isRef.call(void 0, dereferenced)) {
...
function getSchemaVersionString(schema, api) {
  if (_chunkVQBEI5WIcjs.isOpenAPI30.call(void 0, api)) {
...
function toJSONSchema(data, opts = {}) {
  ...
  const schemaAdditionalProperties = _chunkVQBEI5WIcjs.isSchema.call(void 0, schema) ? schema.additionalProperties : null;
  const {
  ...
  if (_chunkVQBEI5WIcjs.isRef.call(void 0, schema)) {
    refLogger(schema.$ref, "ref");
    return transformer(schema);
  }
  if (_chunkVQBEI5WIcjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild)) {
    ...
    ["anyOf", "oneOf"].forEach((polyType) => {
      if (polyType in schema && Array.isArray(schema[polyType])) {
        ...
        schema[polyType].forEach((item, idx) => {
          if (!_optionalChain([schema, 'access', _4 => _4[polyType], 'optionalAccess', _5 => _5[idx]])) {
            return;
          }
          const polyOptions = {
            addEnumsToDescriptions,
      ...
      if (schema.type.length === 1) {
        ...
        if (schema.type.length === 2 && isNullable) {
          ...
          Object.entries({
            ...
            if (!_optionalChain([schema, 'access', _6 => _6.type, 'optionalAccess', _7 => _7.includes, 'call', _8 => _8(typeKey)])) {
              return;
            }
  ...
  if (_chunkVQBEI5WIcjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild)) {
    ...
    if ("example" in schema) {
      ...
      if (typeof schema.examples === "object" && schema.examples !== null && !Array.isArray(schema.examples)) {
        ...
        Object.keys(schema.examples).forEach((name) => {
          const example = _optionalChain([schema, 'access', _9 => _9.examples, 'optionalAccess', _10 => _10[name]]);
          if ("$ref" in example) {
    ...
    if (hasSchemaType(schema, "array")) {
      if ("items" in schema && schema.items !== void 0) {
        if (!Array.isArray(schema.items) && Object.keys(schema.items).length === 1 && _chunkVQBEI5WIcjs.isRef.call(void 0, schema.items)) {
      ...
      if ("properties" in schema && schema.properties !== void 0) {
        Object.keys(schema.properties).forEach((prop) => {
          if (Array.isArray(_optionalChain([schema, 'access', _11 => _11.properties, 'optionalAccess', _12 => _12[prop]])) || typeof _optionalChain([schema, 'access', _13 => _13.properties, 'optionalAccess', _14 => _14[prop]]) === "object" && _optionalChain([schema, 'access', _15 => _15.properties, 'optionalAccess', _16 => _16[prop]]) !== null) {
  ...
  if (_chunkVQBEI5WIcjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild) && globalDefaults && Object.keys(globalDefaults).length > 0 && currentLocation) {
    try {
  ...
  if (_chunkVQBEI5WIcjs.isSchema.call(void 0, schema, isPolymorphicAllOfChild) && "enum" in schema && Array.isArray(schema.enum)) {
...
function getParametersAsJSONSchema(operation, api, opts) {
  ...
  function getDeprecated(schema, type) {
    if (_optionalChain([opts, 'optionalAccess', _17 => _17.retainDeprecatedProperties])) {
      return null;
    }
    ...
    Object.keys(deprecatedBody.properties || {}).forEach((key) => {
      const deprecatedProp = _optionalChain([deprecatedBody, 'access', _18 => _18.properties, 'optionalAccess', _19 => _19[key]]);
    ...
    const deprecatedSchema = toJSONSchema(deprecatedBody, {
      globalDefaults: _optionalChain([opts, 'optionalAccess', _20 => _20.globalDefaults]),
      hideReadOnlyProperties: _optionalChain([opts, 'optionalAccess', _21 => _21.hideReadOnlyProperties]),
      hideWriteOnlyProperties: _optionalChain([opts, 'optionalAccess', _22 => _22.hideWriteOnlyProperties]),
      prevExampleSchemas: [],
      refLogger,
      transformer: _optionalChain([opts, 'optionalAccess', _23 => _23.transformer])
    });
    if (Object.keys(deprecatedSchema).length === 0 || Object.keys(deprecatedSchema.properties || {}).length === 0) {
      return null;
    }
    Object.keys(schema.properties).forEach((key) => {
      if ((_optionalChain([schema, 'access', _24 => _24.properties, 'optionalAccess', _25 => _25[key]])).deprecated && !requiredParams.includes(key)) {
         _optionalChainDelete([schema, 'access', _26 => _26.properties, 'optionalAccess', _27 => delete _27[key]]);
      }
    });
    return {
      type,
  ...
  function transformRequestBody() {
    ...
    if ("example" in mediaTypeObject) {
      ...
      prevExampleSchemas.push({
        examples: Object.values(mediaTypeObject.examples || {}).map((example) => {
          if (_chunkVQBEI5WIcjs.isRef.call(void 0, example)) {
            return void 0;
          }
    ...
    const cleanedSchema = toJSONSchema(requestSchema, {
      globalDefaults: _optionalChain([opts, 'optionalAccess', _28 => _28.globalDefaults]),
      hideReadOnlyProperties: _optionalChain([opts, 'optionalAccess', _29 => _29.hideReadOnlyProperties]),
      hideWriteOnlyProperties: _optionalChain([opts, 'optionalAccess', _30 => _30.hideWriteOnlyProperties]),
      prevExampleSchemas,
      refLogger,
      transformer: _optionalChain([opts, 'optionalAccess', _31 => _31.transformer])
    });
    ...
    return {
      ...
      deprecatedProps: _nullishCoalesce(getDeprecated(cleanedSchema, type), () => ( void 0)),
  ...
  function transformComponents() {
    ...
    Object.keys(api.components).forEach((componentType) => {
      ...
      if (typeof _optionalChain([api, 'access', _32 => _32.components, 'optionalAccess', _33 => _33[cType]]) === "object" && !Array.isArray(api.components[cType])) {
        Object.keys(_optionalChain([api, 'access', _34 => _34.components, 'optionalAccess', _35 => _35[cType]]) || {}).forEach((schemaName) => {
          const componentSchema = cloneObject(_optionalChain([api, 'access', _36 => _36.components, 'optionalAccess', _37 => _37[cType], 'optionalAccess', _38 => _38[schemaName]]));
          if (!components2[cType]) {
            components2[cType] = {};
          }
          components2[cType][schemaName] = toJSONSchema(componentSchema, {
            globalDefaults: _optionalChain([opts, 'optionalAccess', _39 => _39.globalDefaults]),
            hideReadOnlyProperties: _optionalChain([opts, 'optionalAccess', _40 => _40.hideReadOnlyProperties]),
            hideWriteOnlyProperties: _optionalChain([opts, 'optionalAccess', _41 => _41.hideWriteOnlyProperties]),
            refLogger,
            transformer: _optionalChain([opts, 'optionalAccess', _42 => _42.transformer])
          });
        });
      }
    });
    Object.keys(components2).forEach((componentType) => {
      const cType = componentType;
      if (!Object.keys(_optionalChain([components2, 'optionalAccess', _43 => _43[cType]]) || {}).length) {
         _optionalChainDelete([components2, 'optionalAccess', _44 => delete _44[cType]]);
      }
    });
    return components2;
  }
  function transformParameters() {
    ...
    const transformed = Object.keys(types).map((type) => {
      ...
      const properties = parameters.reduce((prev, current) => {
        ...
        if ("schema" in current) {
          ...
          const interimSchema = toJSONSchema(currentSchema, {
            ...
            globalDefaults: _optionalChain([opts, 'optionalAccess', _45 => _45.globalDefaults]),
            hideReadOnlyProperties: _optionalChain([opts, 'optionalAccess', _46 => _46.hideReadOnlyProperties]),
            hideWriteOnlyProperties: _optionalChain([opts, 'optionalAccess', _47 => _47.hideWriteOnlyProperties]),
            refLogger,
            transformer: _optionalChain([opts, 'optionalAccess', _48 => _48.transformer])
          });
          ...
          if (contentKeys.length) {
            ...
            if (contentType && typeof current.content[contentType] === "object" && "schema" in current.content[contentType]) {
              ...
              const interimSchema = toJSONSchema(currentSchema, {
                currentLocation: `/${current.name}`,
                globalDefaults: _optionalChain([opts, 'optionalAccess', _49 => _49.globalDefaults]),
                hideReadOnlyProperties: _optionalChain([opts, 'optionalAccess', _50 => _50.hideReadOnlyProperties]),
                hideWriteOnlyProperties: _optionalChain([opts, 'optionalAccess', _51 => _51.hideWriteOnlyProperties]),
                refLogger,
      ...
      return {
        ...
        label: types[type],
        schema,
        deprecatedProps: _nullishCoalesce(getDeprecated(schema, type), () => ( void 0))
      };
    }).filter((item) => item !== null);
    if (!_optionalChain([opts, 'optionalAccess', _53 => _53.mergeIntoBodyAndMetadata])) {
      return transformed;
    } else if (!transformed.length) {
      return [];
    }
    const deprecatedProps = transformed.map((r) => _optionalChain([r, 'access', _54 => _54.deprecatedProps, 'optionalAccess', _55 => _55.schema]) || null).filter(Boolean);
    return [
      {
        type: "metadata",
  ...
  const typeKeys = _chunkAYA3UT4Lcjs.getExtension.call(void 0, _chunkAYA3UT4Lcjs.PARAMETER_ORDERING, api, operation).map((k) => k.toLowerCase());
  ...
  const shouldIncludeComponents = hasCircularRefs || hasDiscriminatorMappingRefs && _optionalChain([opts, 'optionalAccess', _56 => _56.includeDiscriminatorMappingRefs]);
...
exports.cloneObject = cloneObject; exports.decodePointer = decodePointer; exports.dereferenceRef = dereferenceRef; exports.getDereferencingOptions = getDereferencingOptions; exports.isObject = isObject; exports.isPrimitive = isPrimitive; exports.matches_mimetype_default = matches_mimetype_default; exports.getParameterContentType = getParameterContentType; exports.getSchemaVersionString = getSchemaVersionString; exports.toJSONSchema = toJSONSchema; exports.types = types; exports.getParametersAsJSONSchema = getParametersAsJSONSchema;
//# sourceMappingURL=chunk-B5WP4BJM.cjs.map