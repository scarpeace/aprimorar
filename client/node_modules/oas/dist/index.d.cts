import { O as Operation, W as Webhook, E as Extensions } from './extensions-9XckV6aO.cjs';
import { Match, ParamData } from 'path-to-regexp';
import { PathsObject, HttpMethods, OASDocument, User, ServerVariable, ServerVariablesObject, Servers, AuthForHAR } from './types.cjs';
import 'json-schema';
