...
declare function getParametersAsJSONSchema(operation: Operation, api: OASDocument, opts?: getParametersAsJSONSchemaOptions): SchemaWrapper[] | null;
...
export { Callback as C, DISABLE_TAG_SORTING as D, type Extensions as E, HEADERS as H, INTERNAL as I, METRICS_ENABLED as M, Operation as O, PARAMETER_ORDERING as P, type SchemaWrapper as S, Webhook as W, type getParametersAsJSONSchemaOptions as a, CODE_SAMPLES as b, EXPLORER_ENABLED as c, OAUTH_OPTIONS as d, PROXY_ENABLED as e, SAMPLES_LANGUAGES as f, getParametersAsJSONSchema as g, SIMPLE_MODE as h, extensionDefaults as i, getExtension as j, hasRootExtension as k, types as t, validateParameterOrdering as v };
