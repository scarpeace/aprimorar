...
export function ResponsavelInfoSection({ parentId, onEdit }: Readonly<ResponsavelInfoSectionProps>) {
  ...
  const isArchived = responsavel.active === false;
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="animate-[fade-up_500ms_ease-out_both]">
            ...
            <div className="grid gap-4 rounded-xl border border-base-300 bg-base-200/30 p-4 sm:grid-cols-2">
              <SummaryItem className="sm:col-span-2" label="Nome completo" value={responsavel.name} />
              <SummaryItem label="CPF" value={formatCpf(responsavel.cpf)} />
              <SummaryItem label="Contato" value={formatPhone(responsavel.contact)} />
          ...
          <div className="animate-[fade-up_600ms_ease-out_both]">
            ...
            <div className="grid gap-4 rounded-xl border border-base-300 bg-base-200/30 p-4 sm:grid-cols-2">
              <SummaryItem
                label="Nascimento"
                value={responsavel.birthdate ? formatDateShortYear(responsavel.birthdate) : "Não informado"}
              />
              <SummaryItem
                label="Criado em"
              ...
              <SummaryItem
                label="Pix"
                value={responsavel.pix || "Não informado"}
              />
              <SummaryItem
                label="Status"
