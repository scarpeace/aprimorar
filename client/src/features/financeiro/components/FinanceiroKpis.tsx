...
import { BrushCleaning, GraduationCap, BanknoteArrowUp, UserCog, HandCoins, BadgeDollarSign } from "lucide-react";
import { useMemo } from "react";
import { MiniCard } from "@/components/ui/mini-card";

type FinanceiroKpisProps = {
  totalDespesas: number;
  totalDespesasPendentes: number;
};


export function FinanceiroKpis({ totalDespesas, totalDespesasPendentes }: FinanceiroKpisProps) {
