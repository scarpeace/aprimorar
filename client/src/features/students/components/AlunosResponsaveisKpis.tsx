...
type AlunosResponsaveisKpisProps = {
...
export function AlunosResponsaveisKpis({ activeStudentsCount, activeParentsCount, totalStudentsCount, totalParentsCount }: AlunosResponsaveisKpisProps) {
  return (
