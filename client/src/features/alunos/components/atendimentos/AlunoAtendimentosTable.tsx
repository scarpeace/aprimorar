...
type AlunoAtendimentoTipo = GetAtendimentosIndividuaisQueryParamsTipoEnumKey | "";

type AlunoAtendimentosTableProps = {
  alunoId: string;
};

export function AlunoAtendimentosTable({ alunoId }: Readonly<AlunoAtendimentosTableProps>) {
    ...
    <Card>
      ...
      <div className="flex flex-wrap items-end gap-3">
        ...
        <SelectField
          ...
          onChange={(value) => changeFilter(() => setTipo(value as AlunoAtendimentoTipo))}
            ...
            <table className="table table-zebra">
              ...
              <tbody>
                {content.map((atendimento) => (
                  ...
                  >
                    <td className="font-semibold">{atendimento.colaboradorNome}</td>
