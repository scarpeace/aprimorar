...
export type ColaboradorAtendimentoTipo = BuscarAtendimentosIndividuaisQueryParamsTipoEnumKey | "";

type ColaboradorAtendimentosFiltersProps = {
  search: string;
  tipo: ColaboradorAtendimentoTipo;
  statusCobranca: string;
  dataInicio: string;
  dataFim: string;
  onSearchChange: (value: string) => void;
  onTipoChange: (value: ColaboradorAtendimentoTipo) => void;
  onStatusCobrancaChange: (value: string) => void;
  onDataInicioChange: (value: string) => void;
  onDataFimChange: (value: string) => void;
};

export function ColaboradorAtendimentosFilters({
  search,
  tipo,
  statusCobranca,
  dataInicio,
  ...
  onDataInicioChange,
  onDataFimChange,
}: Readonly<ColaboradorAtendimentosFiltersProps>) {
  return (
    <div className="flex flex-wrap items-end gap-3">
      ...
      <SelectField
        ...
        onChange={(value) => onTipoChange(value as ColaboradorAtendimentoTipo)}
