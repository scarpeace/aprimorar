...
export function AlunosKpis() {
  ...
  return (
    <section className="app-shell-card p-6">
      <h2 className="text-center text-xl font-bold text-base-content">Indicadores</h2>
      ...
      <div className="mt-6 flex justify-between">
        <div className="space-y-1 md:pr-6">
          ...
          <p className="text-center text-3xl font-bold text-base-content">{alunosKpis.data?.totalAlunos ?? 0}</p>
        </div>
        ...
        <div className="space-y-1 md:pl-6">
          ...
          <p className="text-center text-3xl font-bold text-success">{alunosKpis.data?.totalAlunosAtivos ?? 0}</p>
        </div>
      </div>
    </section>
  );
