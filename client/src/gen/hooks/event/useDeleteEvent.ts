...
import { deleteEventMutationResponseSchema } from "../../zod/event/deleteEventSchema.ts";
 ...
 */
export async function deleteEvent(eventId: DeleteEventPathParams["eventId"], config: Partial<RequestConfig> & { client?: Client } = {}) {
