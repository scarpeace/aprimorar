...
export const activateAlunoMutationKey = () => [{ url: "/instituicao/alunos/:alunoId/ativar" }] as const;

export type ActivateAlunoMutationKey = ReturnType<typeof activateAlunoMutationKey>;

/**
 * @description Ativa um aluno por ID.
 * {@link /instituicao/alunos/:alunoId/ativar}
 */
export async function activateAluno(
  ...
  const res = await request<
    ...
    unknown
  >({ method: "PATCH", url: `/instituicao/alunos/${alunoId}/ativar`, ...requestConfig });
  return res.data;
}
