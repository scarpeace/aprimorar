...
export const deactivateAlunoMutationKey = () => [{ url: "/instituicao/alunos/:alunoId/desativar" }] as const;

export type DeactivateAlunoMutationKey = ReturnType<typeof deactivateAlunoMutationKey>;

/**
 * @description Desativa um aluno por ID.
 * {@link /instituicao/alunos/:alunoId/desativar}
 */
export async function deactivateAluno(
  ...
  const res = await request<
    ...
    unknown
  >({ method: "PATCH", url: `/instituicao/alunos/${alunoId}/desativar`, ...requestConfig });
  return res.data;
}
