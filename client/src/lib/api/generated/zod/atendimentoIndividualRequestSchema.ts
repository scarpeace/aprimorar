 ...
 */
export const atendimentoIndividualRequestSchema = z
  .object({
    tipo: z
    ...
    valorCobranca: z.number().describe("Valor da cobrança do aluno"),
    valorRepasse: z.number().describe("Valor do repasse ao colaborador"),
