...
export const colaboradorResponseFuncaoEnum = {
  PROFESSOR: "PROFESSOR",
...
export type ColaboradorResponseFuncaoEnumKey = (typeof colaboradorResponseFuncaoEnum)[keyof typeof colaboradorResponseFuncaoEnum];
...
export type ColaboradorResponse = {
   ...
   * @type string
   */
  funcao: ColaboradorResponseFuncaoEnumKey;
  /**
