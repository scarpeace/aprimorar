import { enderecoFormSchema } from "@/utils/zod/endereco-form-schema.ts";
...
export const alunoFormSchema = z.object({
  ...
  responsavelId: z.uuid().min(1, { message: "Um aluno não pode ser cadastrado sem um responsável" }),
});
