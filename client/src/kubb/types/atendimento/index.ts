...
} from "./GetAtendimentosByAluno.ts";
export type {
...
} from "./GetAtendimentosByColaborador.ts";
export type {
...
} from "./GetAtendimentosContentReport.ts";
export type {
...
} from "./GetIndicadoresAtendimentos.ts";
export type {
...
} from "./GetOverviewFinanceiroAlunos.ts";
export type {
