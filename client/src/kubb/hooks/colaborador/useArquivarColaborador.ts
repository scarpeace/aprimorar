 ...
 */
export async function arquivarColaborador(
...
export function arquivarColaboradorMutationOptions<TContext = unknown>(
  config: Partial<RequestConfig> & { client?: Client } = {},
) {
 ...
 * {@link /v1/colaboradores/:colaboradorId/archive}
 */
export function useArquivarColaborador<TContext>(
  options: {
