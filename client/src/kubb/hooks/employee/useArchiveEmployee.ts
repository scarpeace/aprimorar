...
export const archiveEmployeeMutationKey = () =>
  [{ url: "/v1/employees/:employeeId/archive" }] as const;

export type ArchiveEmployeeMutationKey = ReturnType<
  typeof archiveEmployeeMutationKey
>;
...
export async function archiveEmployee(
  ...
  >({
    method: "PATCH",
    url: `/v1/employees/${employeeId}/archive`,
...
export function archiveEmployeeMutationOptions<TContext = unknown>(
  config: Partial<RequestConfig> & { client?: Client } = {},
) {
...
export function useArchiveEmployee<TContext>(
  ...
  const mutationKey =
    mutationOptions.mutationKey ?? archiveEmployeeMutationKey();

  const baseOptions = archiveEmployeeMutationOptions(
    config,
