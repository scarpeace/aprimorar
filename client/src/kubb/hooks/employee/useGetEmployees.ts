...
export const getEmployeesQueryKey = (params?: GetEmployeesQueryParams) =>
  [{ url: "/v1/employees" }, ...(params ? [params] : [])] as const;
...
export function useGetEmployees<
  TData = GetEmployeesQueryResponse,
  TQueryData = GetEmployeesQueryResponse,
  TQueryKey extends QueryKey = GetEmployeesQueryKey,
>(
  params?: GetEmployeesQueryParams,
  options: {
    query?: Partial<
