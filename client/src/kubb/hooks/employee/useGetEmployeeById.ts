...
export const getEmployeeByIdQueryKey = (
  employeeId: GetEmployeeByIdPathParams["employeeId"],
) =>
  [
    { url: "/v1/employees/:employeeId", params: { employeeId: employeeId } },
  ] as const;

export type GetEmployeeByIdQueryKey = ReturnType<
  typeof getEmployeeByIdQueryKey
>;
...
export function useGetEmployeeById<
  TData = GetEmployeeByIdQueryResponse,
  TQueryData = GetEmployeeByIdQueryResponse,
  TQueryKey extends QueryKey = GetEmployeeByIdQueryKey,
>(
  employeeId: GetEmployeeByIdPathParams["employeeId"],
  options: {
    query?: Partial<
  ...
  const queryKey =
    resolvedOptions?.queryKey ?? getEmployeeByIdQueryKey(employeeId);
