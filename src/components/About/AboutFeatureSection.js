...
const AboutFeatureSection = () => {
  return (
    <div className="features-area section-bg fix ">
            ...
            <div className="features-box text-center mb-30">
              ...
              <div className="features-text">
                ...
                <p>
                  ...
                  earn money on each paid enrollment and find the university
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="features-box text-center mb-30">
              ...
              <div className="features-text">
                ...
                <p>
                  ...
                  have of control your own content. If you are passionate
                </p>
              </div>
            </div>
          </div>
          <div className="col-xl-4 col-lg-4 col-md-6 col-sm-12">
            <div className="features-box text-center mb-30">
              ...
              <div className="features-text">
                <h4>Earn Money</h4>
                <p>
                  Earn money from Law is a career-oriented course after your
                  12th or graduation. We have jotted some of the instructors.
                </p>
              </div>
            </div>
          </div>
