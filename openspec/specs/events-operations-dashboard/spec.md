# Capability: Events Operations Dashboard

## Purpose
Provide a centralized view for managing tactical event operations, including filtering for pending student charges and employee payments, with an all-time default view and optimized UI performance.
