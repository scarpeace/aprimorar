...
public class EventExceptionHandler {
    ...
    public ProblemResponseDTO handleNotFound(EventNotFoundException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(EventScheduleConflictException.class)
    @ApiResponse(
        responseCode = "400",
        description = "Requisição inválida",
        content = @Content(mediaType = "application/json", schema = @Schema(implementation = ProblemResponseDTO.class))
    )
    public ProblemResponseDTO handleConflict(EventScheduleConflictException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler({ InvalidEventException.class, NotAllowedToUpdateEventException.class })
    @ApiResponse(
        responseCode = "403",
