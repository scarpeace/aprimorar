...
public final class AppointmentSpecifications {
    ...
    public static Specification<Appointment> contentContainsIgnoreCase(String term) {
    ...
    public static Specification<Appointment> withEndDateBefore(Instant endDate) {
        return (root, query, cb) -> endDate == null ? null : cb.lessThanOrEqualTo(root.get("endDate"), endDate);
    }

    public static Specification<Appointment> withStudentId(UUID studentId) {
        return (root, query, cb) -> studentId == null ? null : cb.equal(root.get("studentId"), studentId);
    }

    public static Specification<Appointment> withEmployeeId(UUID employeeId) {
        return (root, query, cb) -> employeeId == null ? null : cb.equal(root.get("employeeId"), employeeId);
    }

    public static Specification<Appointment> withStudentIds(List<UUID> studentIds) {
        return (root, query, cb) -> {
            if (studentIds == null) {
                return null;
            }
    ...
    public static Specification<Appointment> withEmployeePaid(Boolean paid) {
        return (root, query, cb) -> {
    ...
    public static Specification<Appointment> withStudentCharged(Boolean charged) {
        return (root, query, cb) -> {
    ...
    public static Specification<Appointment> withEmployeeIds(List<UUID> employeeIds) {
        return (root, query, cb) -> {
            if (employeeIds == null) {
                return null;
            }
