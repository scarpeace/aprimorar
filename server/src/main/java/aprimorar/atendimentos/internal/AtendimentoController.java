...
public class AtendimentoController {
    ...
    private final AtendimentoManagementService appointmentService;

    public AtendimentoController(AtendimentoManagementService appointmentService) {
    ...
    public ResponseEntity<AtendimentoResponseDTO> createAppointment(@RequestBody @Valid AtendimentoRequestDTO request) {
        AtendimentoResponseDTO created = appointmentService.createAppointment(request);
    ...
    public ResponseEntity<AtendimentoResponseDTO> getAppointmentById(@PathVariable UUID id) {
        AtendimentoResponseDTO found = appointmentService.findById(id);
    ...
    public ResponseEntity<AtendimentoResponseDTO> updateAppointment(@PathVariable UUID id, @RequestBody @Valid AtendimentoRequestDTO request) {
        return ResponseEntity.ok(appointmentService.updateAppointment(id, request));
    }

    @DeleteMapping("/{id}")
    @Operation(
        operationId = "deletarAtendimento",
    ...
    @Operation(
        operationId = "alternarCobrancaAlunoAtendimento",
