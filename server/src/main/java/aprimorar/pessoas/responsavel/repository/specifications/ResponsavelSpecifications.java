package aprimorar.pessoas.responsavel.repository.specifications;
...
public final class ResponsavelSpecifications {
    ...
    public static Specification<ResponsavelEntity> comFiltros(ResponsavelFiltroRequest filtro) {
    ...
    public static Specification<ResponsavelEntity> nomeContem(String nome) {
    ...
    public static Specification<ResponsavelEntity> emailContem(String email) {
        return (root, query, cb) -> {
    ...
    public static Specification<ResponsavelEntity> cpfContem(String cpf) {
        return (root, query, cb) -> {
    ...
    public static Specification<ResponsavelEntity> isNotGhost() {
