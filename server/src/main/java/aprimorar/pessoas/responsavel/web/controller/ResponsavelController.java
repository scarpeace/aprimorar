package aprimorar.pessoas.responsavel.web.controller;

import aprimorar.pessoas.responsavel.ResponsavelServiceImpl;
...
public class ResponsavelController {
    ...
    public ResponseEntity<ResponsavelResponseDTO> createResponsavel(@RequestBody @Valid ResponsavelRequestDTO responsavelRequestDTO) {
        ResponsavelResponseDTO responsavel = responsavelService.createResponsavel(responsavelRequestDTO);
    ...
    public ResponseEntity<Page<ResponsavelResponseDTO>> getResponsaveis(
        ...
        return ResponseEntity.ok(responsavelService.getResponsaveis(filtro, pageable));
    }
    ...
    public ResponseEntity<List<ResponsavelResponseDTO>> listResponsaveis() {
        return ResponseEntity.ok(responsavelService.getResponsaveisList());
    }
    ...
    public ResponseEntity<ResponsavelResponseDTO> getResponsavelById(@PathVariable UUID responsavelId) {
        ResponsavelResponseDTO responsavel = responsavelService.findResponsavelById(responsavelId);
    ...
    public ResponseEntity<ResponsavelResponseDTO> updateResponsavel(
        ...
        ResponsavelResponseDTO responsavel = responsavelService.updateResponsavel(responsavelId, responsavelRequestDTO);
        return ResponseEntity.ok(responsavel);
    }
    ...
    public ResponseEntity<Void> deleteResponsavel(@PathVariable UUID responsavelId) {
        responsavelService.deleteResponsavel(responsavelId);
