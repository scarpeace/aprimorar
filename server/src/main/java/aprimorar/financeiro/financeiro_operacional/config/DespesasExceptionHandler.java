package aprimorar.financeiro.financeiro_operacional.config;
...
import aprimorar.financeiro.financeiro_operacional.domain.exception.DespesaDadosInvalidosException;
import aprimorar.financeiro.financeiro_operacional.domain.exception.DespesaNaoEncontradaException;

@Order(Ordered.HIGHEST_PRECEDENCE)
@RestControllerAdvice(basePackages = "aprimorar.financeiro.financeiro_operacional.web")
