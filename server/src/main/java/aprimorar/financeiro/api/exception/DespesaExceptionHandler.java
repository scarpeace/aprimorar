...
public class DespesaExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(DespesaExceptionHandler.class);
    ...
    public ProblemResponseDTO handleNotFound(DespesaNotFoundException ex, HttpServletRequest request) {
