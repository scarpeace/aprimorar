...
@Getter
@Entity
@Table(name = "repasse_pagamentos")
public class RepassePagamento {
    ...
    @OrderBy("id ASC")
    private List<Repasse> repasses = new ArrayList<>();

    protected RepassePagamento() {
    }

    public RepassePagamento(
