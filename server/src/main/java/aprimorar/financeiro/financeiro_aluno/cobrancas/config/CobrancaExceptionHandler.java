package aprimorar.financeiro.financeiro_aluno.cobrancas.config;
...
@RestControllerAdvice(basePackages = "aprimorar.financeiro.financeiro_aluno.cobrancas.web")
public class CobrancaExceptionHandler {
    ...
    @ExceptionHandler(CobrancaAlunoDadosInvalidosException.class)
    public ResponseEntity<ProblemDetail> handleBadRequest(
        CobrancaAlunoDadosInvalidosException ex,
        HttpServletRequest request
    ) {
