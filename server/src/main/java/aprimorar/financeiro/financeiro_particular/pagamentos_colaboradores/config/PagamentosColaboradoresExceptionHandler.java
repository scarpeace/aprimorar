package aprimorar.financeiro.financeiro_particular.pagamentos_colaboradores.config;
...
public class PagamentosColaboradoresExceptionHandler {

    private static final Logger log = LoggerFactory.getLogger(
        PagamentosColaboradoresExceptionHandler.class
    );
