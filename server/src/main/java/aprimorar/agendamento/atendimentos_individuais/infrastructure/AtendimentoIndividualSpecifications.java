...
public final class AtendimentoIndividualSpecifications {
    ...
    public static Specification<AtendimentoIndividual> comFiltros(
    ...
    private static Specification<AtendimentoIndividual> inicioMaiorOuIgual(
    ...
    private static Specification<AtendimentoIndividual> fimMenorOuIgual(
        LocalDateTime fim
    ) {
    ...
    private static Specification<AtendimentoIndividual> tipoIgual(
    ...
    private static Specification<AtendimentoIndividual> statusIgual(
