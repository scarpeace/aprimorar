package aprimorar.agendamento.atendimentos_individuais.web.dto.calendario;
...
public record AtendimentoIndividualCalendarioResponse(
    ...
    public static AtendimentoIndividualCalendarioResponse toDto(AtendimentoIndividual atendimento) {
