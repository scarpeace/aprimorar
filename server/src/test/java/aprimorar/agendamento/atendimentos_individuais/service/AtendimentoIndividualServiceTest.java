...
class AtendimentoIndividualServiceTest {
    ...
    @Mock
    private aprimorar.agendamento.alunos.service.AlunoService alunoService;

    @Mock
    private aprimorar.agendamento.colaboradores.service.ColaboradorService colaboradorService;
