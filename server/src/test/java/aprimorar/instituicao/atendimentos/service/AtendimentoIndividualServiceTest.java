...
class AtendimentoIndividualServiceTest {
    ...
    void shouldRejectSchedulingWithInactiveColaborador() {
        ...
        UUID colaboradorId = UUID.randomUUID();
        AlunoEntity aluno = aluno();
        ColaboradorEntity colaborador = colaborador();
    ...
    void shouldCreateAttendanceAndFinancialEntries() {
        ...
        AtendimentoIndividualEntity atendimento = atendimento(aluno, colaborador);
    ...
    private static AtendimentoIndividualEntity atendimento(AlunoEntity aluno, ColaboradorEntity colaborador) {
    ...
    private static AlunoEntity aluno() {
    ...
    private static ColaboradorEntity colaborador() {
