...
import { atendimentoMonthTabs, atendimentoStatusOptions, atendimentoTipoOptions } from "@/lib/constants/atendimento-constants";
...
export function AtendimentosOverview() {
  ...
  const content = useMemo(() => atendimentos.data?.content ?? [], [atendimentos.data?.content]);
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <form className="flex flex-col gap-3" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-3 md:flex-row md:items-end">
            <SearchInput label="Buscar" value={searchInput} onChange={setSearchInput} placeholder="Digite aluno, colaborador ou tipo" />
                  ...
                  {isActive ? (
                    <div className="space-y-4">
                      {atendimentos.isLoading ? (
                        <PageLoading message="Carregando atendimentos..." />
                      ) : atendimentos.error ? (
                        <ErrorCard
